...
export const metadata: Metadata = {
  title: "Contact the Decision Integrity Practice",
  description:
    "Contact Marc Paul about an independent AI or software investment review, or use the dedicated form for a defined initiative and decision.",
  alternates: { canonical: "/contact" },
  openGraph: {
    title: "Contact Marc Paul | Decision Integrity Practice",
    description: "Send a general enquiry or start a defined AI or software initiative review request.",
    url: "/contact"
  }
};
...
export default function ContactPage() {
  return (
    <main id="main-content">
      <PageHero
        eyebrow="Contact"
        title="Contact the practice about a possible review."
        lead="Use this page for a general enquiry. If an AI or software decision already has an owner and deadline, use the review request instead."
      ...
      <section className="section section-contrast" aria-labelledby="review-contact-title">
        <div className="shell content-split">
          ...
          <div className="prose-block">
            <p>
              The request covers the initiative, decision, deadline, commitment, owner, sponsor, and
