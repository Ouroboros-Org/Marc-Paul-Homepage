...
export const metadata: Metadata = {
  title: "When to Review an AI or Software Initiative",
  description:
  ...
  return (
    <main id="main-content">
      <PageHero
        ...
        title="Commission the review while realistic alternatives remain."
        lead="The service fits a defined AI or software decision with a named owner, a deadline, evidence to examine, and material consequences. It can also preserve unresolved disagreement before approval."
      ...
      <section className="section section-tight" aria-labelledby="moments-title">
        <div className="shell">
          <SectionHeading
            ...
            id="moments-title"
            intro={<p>The commitment, available evidence, alternatives, and consequences determine which review is appropriate.</p>}
          />
      ...
      <section className="section section-dark" aria-labelledby="not-yet-title">
        <div className="shell content-split">
          <div>
            ...
            <h2 id="not-yet-title">The service begins when there is a material decision to make.</h2>
          </div>
      ...
      <section className="section" aria-labelledby="brief-title">
        <div className="shell brief-panel">
          <div>
            ...
            <h2 id="brief-title">State the decision in one sentence.</h2>
          </div>
          <blockquote>
            Should the company fund the proposed move of its customer-support AI pilot into production across three markets?
          </blockquote>
          <p>“Review our AI strategy” is too broad. The initial brief should identify the decision, initiative, deadline, commitment, owner, evidence, sponsor, and reporting context.</p>
      ...
      <CtaPanel
        ...
        text="Send the choice, deadline, evidence available, and consequences involved for an initial assessment of scope and fit."
      />
    </main>
  );
}
